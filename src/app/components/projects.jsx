          ...
          <Tabs defaultActiveKey="profile">
            <Tab eventKey="home" title="Client Indications">
              <ul>
                ...
                <li>
                  Used .Net Core 2 and ServiceStack to reduce the complexity of
                  the backend microservices.
                </li>
                <li>
                  Used NUnit testing utility to ensure the integrity and overall
                  quality of the microservices.
                </li>
                <li>
                  Used RabbitMQ for increased daily valuation process for
                  hundreds of thousands of transactions bringing up to date data
                  for the clients.
                </li>
              </ul>
            </Tab>
            <Tab eventKey="profile" title="Drop Table">
              <ul>
                ...
                <li>
                  Used MongoDB for data storage for compatibility and increased
                  data query speed.
                </li>
                <li>
                  Used Jest/Enzyme testing utility to test my microservices to
                  ensure robust functionality.
                </li>
                <li>
                  Used HTTP-proxy to combine individual micro-services to
                  guarantee the integrity of the overall system for the clients.
                </li>
                <li>
                  Deployed with Docker to Amazon Web Service EC2 to allow the
            ...
            <Tab eventKey="contact" title="Bed And Breakfast">
              <li>
                Used ExpressJS for its flexibility to serve review entrees to
                the clients.
              </li>
              <li>
              ...
              <li>
                Used NGINX to horizontally scale EC2 server instances for better
                response time.
              </li>
              <li>
                Used Redis for simple rapid data caching and data retrieval.
              </li>
            </Tab>
          </Tabs>
        </div>
